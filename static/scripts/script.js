...
// list of details
var uvd = `This refers to any abnormal or atypical discharge from the vagina. Any abnormal discharge from the vagina that differs in color, consistency, or odor from your usual discharge.\n\nይህ ከሴት ብልት የሚወጣ ማንኛውንም ያልተለመደ ፈሳሽን ይመለከታል።ከሴት ብልት የሚወጣ ማንኛውም ያልተለመደ ፈሳሽ በቀለም፣ ወጥነት ወይም ጠረን ከወትሮው ፈሳሽዎ ይለያል።`;
var pdu = "This asks if there is pain or discomfort experienced while urinating. Pain or discomfort experienced while urinating.\n\nይህ በሽንት ጊዜ የሚያጋጥም ህመም ካለ ይጠይቃል።"
const vi = "This asks if there is an itching sensation in the vaginal area. Itching or irritation in the vaginal area.\n\nይህ በሴት ብልት አካባቢ የማሳከክ ስሜት እንዳለ ይጠይቃል።"
const pds = "This asks if there is pain or discomfort experienced during sexual intercourse. Painful intercourse, often felt as discomfort or sharp pain during penetration.\n\nይህ በግብረ ሥጋ ግንኙነት ወቅት የሚያጋጥም ህመም ወይም ምቾት ካለ ይጠይቃል። የሚያሳምም የግብረ ሥጋ ግንኙነት፣ ብዙ ጊዜ እንደ አለመመቸት ወይም ወደ ውስጥ በሚገቡበት ጊዜ ከፍተኛ ህመም ይሰማዋል።"
const gs = "This asks if there are any open or ulcerated sores in the genital area. Painful or tender areas on the genitals, indicating potential infection or irritation.\n\nይህ በጾታ ብልት አካባቢ ምንም አይነት ክፍት ወይም ቁስለት እንዳለ ይጠይቃል። በጾታ ብልት ላይ የሚያሰቃዩ ወይም ለስላሳ ቦታዎች፣ ይህም ኢንፌክሽን ወይም ብስጭት መኖሩን ያሳያል።"
const lap = "This asks if there is pain or discomfort in the lower part of the abdomen, below the belly button. Pain or discomfort below the belly button, often indicating various underlying issues.\n\nይህ ከሆድ በታች ባለው የሆድ ክፍል ውስጥ ከሆድ በታች ህመም ወይም ምቾት መኖሩን ይጠይቃል። ከሆድ ግርጌ በታች ህመም ወይም ምቾት ማጣት ይህም ብዙ ጊዜ የተለያዩ ችግሮችን ያሳያል።"
const f = "This asks if there is an elevated body temperature. Elevated body temperature, which can be a sign of infection or inflammation.\n\nይህ ከፍ ያለ የሰውነት ሙቀት መኖሩን ይጠይቃል። የሰውነት ሙቀት መጨመር፣ ይህም የኢንፌክሽን ወይም እብጠት ምልክት ሊሆን ይችላል።"
const vd = "This asks if there is any type of discharge coming from the vagina. Vaginal discharge: Normal or abnormal fluid coming from the vagina.\n\nይህ ከሴት ብልት የሚወጣ አይነት ፈሳሽ ካለ ይጠይቃል። የሴት ብልት ፈሳሽ፡ ከሴት ብልት የሚወጣ መደበኛ ወይም ያልተለመደ ፈሳሽ።"
const mmp = "This asks if there has been a skipped menstrual period. Skipping a menstrual cycle without pregnancy, which can indicate various health issues.\n\nይህ የወር አበባ ጊዜ ያለፈ መሆኑን ይጠይቃል። እርግዝና ሳይኖር የወር አበባ ዑደትን መዝለል የተለያዩ የጤና ችግሮችን ሊያመለክት ይችላል።"
const vb = "This asks if there is any bleeding from the vagina outside of the normal menstrual cycle. Vaginal bleeding: Abnormal bleeding from the vagina, outside of regular menstruation.\n\nይህ ከተለመደው የወር አበባ ዑደት ውጪ ከሴት ብልት የሚመጣ ደም መፍሰስ እንዳለ ይጠይቃል። የሴት ብልት ደም መፍሰስ፡ ከሴት ብልት ያልተለመደ ደም መፍሰስ፣ ከወር አበባ ውጪ።"
const pil = "This asks if there is pain or swelling in the lymph nodes located in the groin area. Discomfort or tenderness in the lymph nodes located in the groin area.\n\nይህ በግራጫ አካባቢ በሚገኙ የሊምፍ ኖዶች ላይ ህመም ወይም እብጠት እንዳለ ይጠይቃል። በግራይን አካባቢ በሚገኙ የሊንፍ ኖዶች ውስጥ ምቾት ማጣት ወይም ርህራሄ።"
const pdfs = "This asks if there is a discharge of pus from any swollen area. Drainage of thick, yellowish fluid from an inflamed or infected area.\n\nይህ ከየትኛውም ያበጠ አካባቢ የንፍጥ ፈሳሽ እንዳለ ይጠይቃል። ከተነደደ ወይም ከተበከለ አካባቢ ወፍራም ቢጫ ቀለም ያለው ፈሳሽ መፍሰስ።"
const scr = "This asks if there are any raised bumps with a rough texture on the genital area, which may be the same color as the surrounding skin. Raised lesions on the genital area, potentially indicative of certain infections or conditions.\n\nይህ በጾታ ብልት አካባቢ ላይ ሸካራ ሸካራነት ያላቸው ከፍ ያሉ እብጠቶች መኖራቸውን ይጠይቃል፣ እነሱም በዙሪያው ካለው ቆዳ ጋር አንድ አይነት ቀለም ሊሆኑ ይችላሉ። በብልት አካባቢ ላይ የተነሱ ቁስሎች አንዳንድ ኢንፌክሽኖችን ወይም ሁኔታዎችን ሊያመለክቱ ይችላሉ።"
const slbf = "This asks if there are any abnormal skin lesions or sores present in the spaces between the fingers, wrists, genital area, or buttocks. Abnormal skin changes or sores in these specific areas.\n\nይህ በጣቶቹ፣ በእጅ አንጓዎች፣ በብልት አካባቢ ወይም በትሮች መካከል ባሉት ክፍተቶች ላይ ምንም አይነት ያልተለመደ የቆዳ ቁስሎች ወይም ቁስሎች እንዳሉ ይጠይቃል። በእነዚህ ልዩ ቦታዎች ላይ ያልተለመደ የቆዳ ለውጦች ወይም ቁስሎች።"
const lnph = "This asks if there are any lice or their eggs (nits) present on the pubic hair. Presence of lice or their eggs (nits) in the pubic hair, indicating infestation.\n\nይህ በጉርምስና ፀጉር ላይ ቅማል ወይም እንቁላሎቻቸው (ኒት) መኖራቸውን ይጠይቃል። ቅማሎች ወይም እንቁላሎቻቸው (ኒት) በጉርምስና ፀጉር ውስጥ መኖራቸው ይህም ኢንፌክሽንን ያሳያል።"
const ye = "This asks if the whites of the eyes appear yellow. Jaundice, a yellow discoloration of the eyes, often a sign of liver or gallbladder issues.\n\nይህ የዓይኑ ነጮች ቢጫ ከታዩ ይጠይቃል። ጃንዲስ፣ የአይን ቢጫ ቀለም፣ ብዙ ጊዜ የጉበት ወይም የሐሞት ፊኛ ችግሮች ምልክት ነው።"
const ys = "This asks if the skin has a yellowish tint. Jaundice affecting the skin, similar to the eyes, indicating potential liver problems.\n\nይህ የቆዳው ቢጫ ቀለም እንዳለው ይጠይቃል። ከዓይን ጋር የሚመሳሰል የቆዳ በሽታ የያዛት በሽታ፣ ይህም የጉበት ችግሮችን ያሳያል።"
const ap = "This asks if there is pain or discomfort in the abdomen. Discomfort or pain in the abdominal region, which can stem from various causes.\n\nይህ በሆድ ውስጥ ህመም ወይም ምቾት እንዳለ ይጠይቃል። ምቾት ወይም የሆድ አካባቢ ህመም በተለያዩ ምክንያቶች ሊመጣ ይችላል።"
const du = "This asks if the urine appears darker in color than usual. Urine that appears darker than usual, potentially indicating dehydration or liver issues.\n\nይህ ሽንት ከወትሮው የበለጠ ጠቆር ያለ መስሎ እንደታየ ይጠይቃል። ሽንት ከወትሮው ጠቆር ያለ መስሎ ይታያል፣ ይህም ድርቀትን ወይም የጉበት ችግሮችን ሊያመለክት ይችላል።"
const pai = "This asks if there is itching in the pubic area. Itching or irritation in the pubic region.\n\nይህ በጉርምስና አካባቢ ማሳከክ እንዳለ ይጠይቃል። በሆድ አካባቢ ማሳከክ ወይም መበሳጨት።"
const iwan = "This asks if the itching sensation becomes more intense during the nighttime. Increased itching sensation experienced during nighttime.\n\nይህ በምሽት ጊዜ የማሳከክ ስሜቱ የበለጠ እየጠነከረ እንደሆነ ይጠይቃል። በሌሊት የሚደርስ የማሳከክ ስሜት ይጨምራል።"
...
const itae = "This asks if there is itching experienced in the thighs, armpit area, or eyelids. Itching or irritation in these specific areas of the body.\n\nይህ በጭኑ፣ በብብት አካባቢ ወይም በዐይን ሽፋሽፍቶች ላይ የሚከሰት ማሳከክ እንዳለ ይጠይቃል። በእነዚህ ልዩ የሰውነት ክፍሎች ላይ ማሳከክ ወይም ብስጭት።"

const ud = "This refers to any abnormal or atypical discharge from the penis or urethra. Abnormal fluid coming from the penis, which can indicate infection or other issues\n\nይህ የሚያመለክተው ማንኛውም ከብልት ወይም ከሽንት ቱቦ የሚወጣ ያልተለመደ ወይም ያልተለመደ ፈሳሽ ነው።ይህ የሚያመለክተው ማንኛውም ከብልት ወይም ከሽንት ቱቦ የሚወጣ ያልተለመደ ወይም ያልተለመደ ፈሳሽ ነው።"
const fu = "This asks if there is an increased need to urinate more often than usual. Needing to urinate more often than usual, potentially indicating urinary tract issues.\n\nይህ ከወትሮው በበለጠ በተደጋጋሚ የመሽናት ፍላጎት መኖሩን ይጠይቃል። ከወትሮው በበለጠ ብዙ ጊዜ መሽናት ስለሚያስፈልገው የሽንት ቱቦ ችግሮችን ሊያመለክት ይችላል።"
const sp = "This asks if there is pain or discomfort in the scrotum (the pouch of skin containing the testicles). Pain or discomfort in the scrotum, the pouch of skin containing the testicles.\n\nይህ በ Scrotum ውስጥ ህመም ወይም ምቾት እንዳለ ይጠይቃል (የቆዳውን የወንድ የዘር ፍሬ የያዘው ከረጢት)። በቁርጥማት ውስጥ ህመም ወይም ምቾት ማጣት፣ የወንድ የዘር ፍሬዎችን የያዘ የቆዳ ቦርሳ።"
const sw = "This asks if there is swelling or enlargement of the scrotum. Swelling or enlargement of the scrotum, potentially indicative of various conditions.\n\nይህ የሆድ ቁርጠት ማበጥ ወይም መስፋፋት እንዳለ ይጠይቃል። የእግር እብጠት ወይም መጨመር የተለያዩ ሁኔታዎችን ሊያመለክት ይችላል።"
const is = "This asks if there is swelling in the groin area. Swelling in the groin area.\n\nይህ ብሽሽት አካባቢ እብጠት እንዳለ ይጠይቃል። በእግር አካባቢ እብጠት።"
const sop = "This asks whether the pain started suddenly or developed gradually over time. Whether the pain in the scrotal area started suddenly or developed gradually.\n\nይህ ሕመሙ በድንገት መጀመሩን ወይም ከጊዜ ወደ ጊዜ ቀስ በቀስ ማደግን ይጠይቃል። በ scrotal አካባቢ ላይ ያለው ህመም በድንገት የጀመረ ወይም ቀስ በቀስ ያደገ እንደሆነ ይጠይቃል።"
...
async function conversationBuilder(message, name = '', description = '') {
	...
	// // Set the textContent of the <pre> element to the description
	// preElement.textContent = description;
